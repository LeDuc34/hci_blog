...
title = "HW1"
description = "About the first homework ?"
slug = ""
authors = []
tags = []
categories = []
...
### Good Example: Gym Authentication System

A good design I've found in my daily life is the authentication system at my gym. To enter the gym, you need to show your badge and place your index finger on a detector to verify that the fingerprint matches the badge owner.

While it might seem excessive, it's actually quite fast and not very demanding for users. It effectively solves the problem of badge sharing between members—with this design, it's quite difficult to defraud the system.
...
### Physical Example: Light Switches

A physical example where gestalt principles went wrong is with the light switches in my apartment. It's difficult to figure out which switch controls which light if you're not familiar with the layout. The design is not intuitive and lacks clear visual grouping.
